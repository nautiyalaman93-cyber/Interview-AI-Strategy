...
import { wakeServer } from '../services/interview.api.js'
            ...
            <div className='interview-card'>
                        ...
                        <div className='upload-section'>
                            ...
                            {selectedFileName ? (
                                <div style={{
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#ef4444" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                                    <span style={{ flex: 1, fontSize: '13px', color: '#4ade80', fontWeight: 500, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                        {selectedFileName}
                                    </span>
                                    <button onClick={() => { setSelectedFileName(""); resumeInputRef.current.value = "" }} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#f87171', fontSize: '18px', lineHeight: 1, padding: '0 4px' }} title="Remove file">✕</button>
                                </div>
                            ) : null}
                ...
                <div className='interview-card__footer'>
                    ...
                    <button
                        ...
                        {isGenerating ? 'Generating... Please wait (30-60s)' : 'Generate My Interview Strategy'}
                    </button>
                </div>
            </div>
